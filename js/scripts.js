...
function renderHeader() {
    ...
    header.innerHTML = `
        <div class="container header-container">
            <a href="index.html" class="logo"><img src="img/logo.webp" alt="Mountain Adventure" width="1024" height="535"></a>
        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-col about">
                    <img src="img/logo.webp" alt="Logo" class="footer-logo" width="1024" height="535">
