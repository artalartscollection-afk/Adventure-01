...
function renderHeader() {
    ...
    header.innerHTML = `
        <div class="container header-container">
            <a href="index.html" class="logo"><img src="img/logo.webp" alt="Mountain Adventure" width="172" height="90"></a>
        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-col about">
                    <img src="img/logo.webp" alt="Logo" class="footer-logo" width="172" height="90">
